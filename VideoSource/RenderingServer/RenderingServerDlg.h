...
// RenderingServerDlg.h : header file
//
...
class CRenderingServerDlg : public CDialogEx
{
// Construction
public:
	CRenderingServerDlg(CWnd* pParent = NULL);	// standard constructor
	~CRenderingServerDlg();

// Dialog Data
	enum { IDD = IDD_RenderingServer_DIALOG };
